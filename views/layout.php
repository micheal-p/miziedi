...
$navCategories = [];
try {
    // Ensure the class exists before calling it to prevent fatal errors during setup
    if (class_exists('\Miziedi\Models\Category')) {
        $categoryModel = new \Miziedi\Models\Category();
        $navCategories = $categoryModel->getAll();
    }
} catch (Exception $e) {
    // Silently fail or log error, but allow the page to load
    error_log("Menu Category Error: " . $e->getMessage());
}
?>
<!DOCTYPE html>
<html lang="en">
...
<header class="site-header">
    <div class="container header-inner">
        ...
        <div class="header-icons">
            ...
            <button class="icon-link" onclick="toggleMusic()" title="Toggle Music">
                <svg id="music-icon-on" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
                <svg id="music-icon-off" style="display:none;" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="1" y1="1" x2="23" y2="23"></line><path d="M9 9v3a3 3 0 0 0 5.12 2.12"></path><path d="M15 9.34V4l-6.81 1.13"></path><circle cx="6" cy="18" r="3"></circle></svg>
            </button>
