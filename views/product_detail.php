...
if (isset($product['sizes'])) {
    $sizes = json_decode(json_encode($product['sizes']), true);
}
?>
...
<style>
    ...
    .qty-input {
        ...
        font-weight: 700;
        color: #000;
        appearance: textfield; /* Hides spinners */
    ...
    .size-input:checked + .size-label {
        background: #000; color: #fff; border-color: #000; transform: scale(1.1);
    }
    ...
    @media (max-width: 768px) { 
        ...
        .detail-image { aspect-ratio: 1/1; } /* Square image on mobile */
